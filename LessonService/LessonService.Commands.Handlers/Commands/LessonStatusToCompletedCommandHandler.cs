...
public class LessonStatusToCompletedCommandHandler(
    ...
    ) : IRequestHandler<LessonStatusToCompletedCommand, ApiResponse<LessonModel>>
{
    ...
    {
        return await unitOfWork.Lessons.SetLessonStatus(command.LessonId, LessonStatus.Completed, cancellationToken);
    }
}